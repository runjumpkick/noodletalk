...
// generate a new nickname for a new session
exports.generateRandomNick = function(userList) {
  var newNick = 'i_love_ie6_v' + (new Date().getTime()) + Math.floor(Math.random() * 100);
  return newNick;
}
