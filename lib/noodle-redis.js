...
const RECENT_MEDIA_LIMIT = 4; // limit recent media to 3, starting at 0
  ...
  client.keys('channelUser:' + channel + ':*', function(err, users) {
    try {
      if (users.length > 0) {
        var userList = [];
        var counter = 0;
        var getUsers = function(users, counter) {
...
exports.getChannelList = function(client, io, callback) {
  client.keys('channels:*', function(err, channels) {
    try {
      var channelList = [];
      var counter = 0;
      var getChannels = function(channels, counter) {
