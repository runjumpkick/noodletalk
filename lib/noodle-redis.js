...
var RECENT_MEDIA_LIMIT = 11; // limit recent media to 10, starting at 0
var RECENT_USER_LIMIT = 41; // limit recent users to 40, starting at 0
 ...
 */
exports.getRecentMessages = function(client, channel, req, callback) {
  // if this is a private message, ensure the user has rights to access the feed
  if (channel.match(PRIVATE_MESSAGE_MATCH) && auth.isValidRSSKey(req.session.email)) {
